            ...
            >
                {HeroData.map((slide) => (
                    <SwiperSlide key={slide.id}>
                        <div className="relative min-h-[480px] md:min-h-[560px] overflow-hidden rounded-[30px] bg-gradient-to-br from-gray- via-gray-50 to-gray-200 dark:from-[#151515] dark:via-[#1c1c1c] dark:to-[#101010] transition-colors duration-500">
