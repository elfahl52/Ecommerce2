...
const Hero = () => {
    ...
    return (
        <section className="container mx-auto px-2 py-3 sm:px-4 sm:py-5 lg:px-6 lg:py-8 dark:bg-gray-800 dark:text-white">
            <Swiper
                ...
                {HeroData.map((slide) => (
                    <SwiperSlide key={slide.id}>
                        ...
                        >
                            ...
                            <div
                                className="
                                    absolute -right-24 -top-24 h-60 w-60
                            ...
                            <div
                                className="
                                    absolute -bottom-28 -left-20 h-56 w-56
                                    rounded-full bg-red-500/5 blur-3xl
                                    sm:h-72 sm:w-72
                                "
                            />
                            ...
                            <div
                                className="
                                    ...
                                    md:flex-row md:px-10 md:py-8
                                    lg:min-h-[500px] lg:px-14
                                    xl:px-20
                                "
                            >
                                {/* Text */}
                                ...
                                >
                                    ...
                                    <h1
                                        ...
                                        data-aos-delay="100"
                                        className="
                                            text-[clamp(2.5rem,8vw,4.8rem)]
                                            font-extrabold leading-[.9]
                                            tracking-tight text-gray-900
                                            dark:text-white
                                            lg:text-[clamp(3.8rem,5vw,5.5rem)]
                                        "
                                    >
                                        {slide.title}
                                    </h1>
                                    ...
                                    <h2
                                        ...
                                        data-aos-delay="200"
                                        className="
                                            -mt-1 text-[clamp(2.5rem,8vw,4.8rem)]
                                    ...
                                    <p
                                        ...
                                        data-aos-delay="300"
                                        className="
                                            mt-4 max-w-sm text-xs leading-5
                                ...
                                <div
                                    ...
                                    data-aos-delay="300"
                                    className="
                                        relative order-1 flex h-[220px]
                                        w-full items-center justify-center
                                        md:order-2 md:h-[380px] md:w-1/2
                                        lg:h-[440px]
                                    "
                                >
                                    {/* Circle */}
