...
export const DealsPage = ({ products = initialProducts }) => (
  <PageShell
...
export const PolicyPage = ({ title, description, items }) => (
...
export const ProductDetailsPage = ({ wishlistIds, onAddToCart, onToggleWishlist }) => {
  const { id } = useParams()
