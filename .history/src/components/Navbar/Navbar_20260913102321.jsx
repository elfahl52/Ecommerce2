...
import { FaSearch, FaShoppingCart, FaChevronDown } from "react-icons/fa"; // أضفت أيقونة السهم الصغير
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="hidden md:flex items-center space-x-6">
                            ...
                            <div className="relative group">
                                ...
                                {/* القائمة المنسدلة (منفصلة عن الزر) */}
                                <div className="absolute left-0 mt-2 w-40 bg-white dark:bg-gray-800 rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-10 border dark:border-gray-700">
                                    <Link 
                                        to="/contact" 
                                        className="block px-4 py-2 text-gray-600 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700 first:rounded-t-md"
                                    >
                                        Contact
                                    </Link>
                                    <Link 
                                        to="/faq" 
                                        className="block px-4 py-2 text-gray-600 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700 last:rounded-b-md"
                                    >
                                        FAQ
                                    </Link>
                                </div>
