...
const Category = () => {
  ...
  return (
    <section 
      className="overflow-hidden py-8 sm:py-12 dark:bg-gray-950" 
      aria-labelledby="categories-heading"
    >
      {/* Added overflow-hidden here as well to contain the grid */}
      <div className="container mx-auto overflow-hidden px-4">
        
        {/* Added overflow-hidden to the grid wrapper */}
