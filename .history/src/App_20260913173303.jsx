...
const ProductDetailsPage = ({ wishlistIds, onAddToCart, onToggleWishlist }) => {
  ...
  return (
    <section className="bg-gray-50 py-14 dark:bg-gray-950 sm:py-16">
      <div className="container mx-auto px-4">
        <div className="rounded-[2rem] border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-900 sm:p-8">
          <div className="grid gap-8 lg:grid-cols-2">
            <div className="overflow-hidden rounded-[1.5rem] bg-gray-100 p-4 dark:bg-gray-800">
